                ...
                <div className="alert alert-primary text-center">
                    ...
                    <div className="text-left">
                        <div>
                            ...
                            <div>Email:{mydata!=null ? mydata.email:""}</div>
                        ...
                        <div className="form-group">
                            <label>Message:</label>
                            <input type="text" onChange={onChangeCmt} className="form-group" />
                        </div>
                    </div>
                    <button className="btn btn-primary" onChange={doAction}>
                        Send Message
                    </button>
                    <button className="btn" onChange={goBack}>
                        Go Back
                    </button>
                </div>
